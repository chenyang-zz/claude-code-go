...
const rememberSkillPrompt = `# Memory Review
...
| **CLAUDE.local.md** | Personal instructions for Claude specific to this user | "I prefer concise responses", "always explain trade-offs" |
...
func registerRememberSkill() {
	// Gate behind CLAUDE_CODE_AUTO_MEMORY env var, matching TS isAutoMemoryEnabled()
	isEnabled := func() bool {
		return os.Getenv("CLAUDE_CODE_AUTO_MEMORY") != "0"
	}
